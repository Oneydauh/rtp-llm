    ...
    native.test_suite(
        ...
        tests = [
            ...
            smoke_test(
                ...
                smoke_args="--warm_up 0 --seq_size_per_block 64 --act_type BF16 --enable_cuda_graph 0 --tp_size 1 --world_size 1 --dp_size 1 --fp8_kv_cache 1 --decode_entrance 1",
                envs=["ACCL_LOW_LATENCY_OPTIMIZE=1"],
                gpu_type=["H20"],
            ),
            smoke_test(
            ...
            smoke_test(
                ...
                envs={
                    ...
                    "decode": []},
                smoke_args={
                    "prefill": "--fp8_kv_cache 1 --act_type BF16 --cache_store_rdma_mode 0 --use_local 1 --reserver_runtime_mem_mb 8192 --role_type PREFILL --seq_size_per_block 64 --dp_size 1 --tp_size 2 --ep_size 2 --world_size 2 --warm_up 0 --use_deepep_moe 1 --use_deepep_low_latency 0 --cp_rotate_method ALL_GATHER --use_all_gather=0 --decode_entrance 1",
                    "decode": "--fp8_kv_cache 1 --act_type BF16 --cache_store_rdma_mode 0 --use_local 1 --reserver_runtime_mem_mb 8192 --role_type DECODE --seq_size_per_block 64 --ep_size 2 --dp_size 2 --world_size 2 --warm_up 0 --use_deepep_moe 1 --use_deepep_low_latency 1 --cp_rotate_method PREFILL_CP --use_all_gather=0 --decode_entrance 1"
                },
                gpu_type=["H20"]
            ),
            smoke_test(
    ...
    native.test_suite(
        ...
        tests = [
            smoke_test(
                ...
                smoke_args="--act_type BF16 --seq_size_per_block 2048 --tp_size 2 --max_seq_len 12800 --reserver_runtime_mem_mb 10000 --sp_model_type qwen35_moe_mtp --gen_num_per_cycle 4 --sp_type eagle --sp_checkpoint_path /mnt/nas1/hf/Qwen3.5-35B-A3B-FP8 --sp_act_type bf16 --decode_entrance 1",
                gpu_type=["H20"],
            ),
            smoke_test(
                name="next_mtp_reuse",
