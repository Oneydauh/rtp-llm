...
def whl_deps():
    return select({
        "@rtp_llm//:using_cuda12": ["torch==2.6.0+cu126", "xgrammar==0.1.32"],
        "@rtp_llm//:using_rocm": ["pyrsmi==0.2.0", "amdsmi@https://sinian-metrics-platform.oss-cn-hangzhou.aliyuncs.com/kis%2FAMD%2Famd_smi%2Fali%2Famd_smi.tar", "aiter@https://sinian-metrics-platform.oss-cn-hangzhou.aliyuncs.com/kis/AMD/RTP/aiter-0.1.13.dev14%2Bgfa35072d0.d20260402-cp310-cp310-linux_x86_64.whl", "xgrammar==0.1.32"],
        "//conditions:default": ["torch==2.1.2", "xgrammar==0.1.32"],
    })
